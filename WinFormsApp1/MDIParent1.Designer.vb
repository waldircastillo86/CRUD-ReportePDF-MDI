...
Partial Class MDIParent1
    ...
    Private Sub InitializeComponent()
        ...
        ' MenuStrip
        ' 
        MenuStrip.Items.AddRange(New ToolStripItem() {FileMenu, EditMenu, ViewMenu, ToolsMenu, WindowsMenu, HelpMenu, CRUDToolStripMenuItem})
        ...
        ' 
        CRUDToolStripMenuItem.DropDownItems.AddRange(New ToolStripItem() {CToolStripMenuItem, RToolStripMenuItem, UToolStripMenuItem, DToolStripMenuItem})
        ...
        UToolStripMenuItem.Size = New Size(82, 22)
